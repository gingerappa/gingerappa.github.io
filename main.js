...
{"html": 
  {
    "en" : {
      ...
      "Y1P1": "<div class='title'> <h1>Camera to text</h1> </div> <main style='width: 99%;height: 99%'> <div style='display: flex;margin-top: 10rem;margin-left: 4rem;margin-right: 4rem;flex-wrap: nowrap;justify-content: space-around;gap: 1rem;'> <div> <img src='img/Y1P1I1.PNG' alt='Image of the code' style='width: 800px;height: 430px;'> </div> <div> <p style='color: #d6d6d6;'> A small program I made for fun in my spare time, it’s a simple script that runs in the terminal  and turns the video input of your camara into text. It does this by checking every pixel the  camera gives adding the rgb values together dividing them by 47.875 (depends on how many  characters u want) which gives a number from 0 to  15 where 0 is the least bright and 15 is the  most bright character. It gives the camara this really cool effect that makes it seem like its ascii art </p> </div> </div> </main> <div id='downB'> <button id='down' class='btn btn-dark'>˅</button> </div>",
      "Y1P2": "<div class='title'> <h1>Random dungeon 2</h1> </div> <main style='width: 99%;height: 99%'> <div style='display: flex;margin-top: 10rem;margin-left: 4rem;margin-right: 4rem;flex-wrap: nowrap;justify-content: space-around;gap: 1rem;'> <div> <img src='img/Y1P2I1.PNG' alt='Image of the code' style='width: 800px;height: 430px;'> </div> <div> <p style='color: #d6d6d6;'> A successor to a program I made in high school. This program randomly generates a dungeon for the role playing game dungeons and dragons. It does this by first creating a starting area than on each side randomly decides what should go there if anything than it generates that and does the same for the things it generateds and repeat until there is noting to generate. I learned a lot from this project, mainly working with the tkinter library in python so I can make windows and a GUI </p> </div> </div> </main> <div id='downB'> <button id='down' class='btn btn-dark'>˅</button> </div>",
      "Y2P1": "<div class='title'> <h1>Webstore</h1> </div> <main style='width: 99%;height: 99%'> <div style='display: flex;margin-top: 10rem;margin-left: 4rem;margin-right: 4rem;flex-wrap: nowrap;justify-content: space-around;gap: 1rem;'> <div> <a href='webstore/index.html'><img src='img/Y2P1I1.PNG' alt='Image of the code' style='width: 800px;height: 430px;'></a> </div> <div> <p style='color: #d6d6d6;'> a non functional webstore i made for school where I sell schools. For this project we had to learn about arrays and learn how JavaScript works. I used a array with object in it for the items and when u want to order a item it puts in in a cart array. The main things I took a way from this project wasn’t the arrays. It was the html and css and using css instead of bootstrap felt so freeing and I had a lot of fun with this project </p> </div> </div> </main> <div id='downB'> <button id='down' class='btn btn-dark'>˅</button> </div>",
...
document.getElementById("left").onclick = function() {switchPlanet("left")}
document.getElementById("right").onclick = function() {switchPlanet("right")}
document.getElementById("aboutMe").onclick = function() {loadPage("aboutMe");move(camera, [camera.position.x+20, camera.position.y + 100, camera.position.z+20], 120)}

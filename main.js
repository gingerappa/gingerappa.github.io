...
function loadPage(pageName){
  ...
  try{
    document.getElementById("webstore").onclick = function() {window.location.href = `/webstore/index.html#${pageName}|${PageCord[0][3]}`};
  }
  catch{
    //pass
  }
...
function opening(element, steps){
  var step = 100/steps
  var opacity = 0
...
if (Object.keys(data.html.en).indexOf(currentUrl[0]) > -1 && exists(PageCord, currentUrl[1])){
